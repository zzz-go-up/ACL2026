...
python verl/scripts/model_merger.py merge \
    --backend fsdp \
    --local_dir checkpoints/DeepSeek-R1-Distill-Qwen-1.5B-no_SFT/test_1/global_step_160/actor \
    --target_dir checkpoints/DeepSeek-R1-Distill-Qwen-1.5B-no_SFT/test_1/global_step_160
