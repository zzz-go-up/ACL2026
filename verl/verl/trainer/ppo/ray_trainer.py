                ...
                with _timer("step", timing_raw):
                    ...
                    with _timer("gen", timing_raw):
                        if not self.async_rollout_mode:
                            ...
                            rollout_sample_0_ids = gen_batch_output.batch["responses"][0]
                            rollout_sample_0_text = self.tokenizer.decode(rollout_sample_0_ids, skip_special_tokens=True)
                            logger.log(data={"rollout_sample_0_text": rollout_sample_0_text}, step=self.global_steps)
                        else:
                            self.async_rollout_manager.wake_up()
