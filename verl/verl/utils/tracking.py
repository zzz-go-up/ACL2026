...
class Tracking:
    ...
    def __init__(self, project_name, experiment_name, default_backend: Union[str, List[str]] = "console", config=None):
        ...
        if "tracking" in default_backend or "wandb" in default_backend:
            ...
            print(f"Saving wandb log to path: {config['trainer']['default_local_dir']}")
            wandb.init(project=project_name, name=experiment_name, config=config, mode='offline', dir=config['trainer']['default_local_dir'])
